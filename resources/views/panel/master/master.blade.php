...
<head>
    ...
    <!-- bootstrap wysihtml5 - teassets/xt editor -->
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                <li class="header">ناوبری اصلی</li>
                        ...
                        <li class="active"><a href="{{route('dashboard.index')}}"><i class="fa fa-circle-o"></i> داشبورد</a></li>
                        <li class="active"><a href="{{route('dashboard.owners')}}"><i class="fa fa-circle-o"></i> لیست صاحبان کسب و کار</a></li>
